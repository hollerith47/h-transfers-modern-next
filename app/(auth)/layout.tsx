...
export default function AuthLayout({ children }: Props) {
    ...
    return (
        <div className="flex min-h-svh relative">
            ...
            {/* Mobile menu links */}
            {isOpen && (
                <div className="fixed top-20 left-0 w-full z-30 md:hidden bg-base-100">
            ...
            <main className={`flex flex-1 w-full transition-all duration-200 ${
                ...
                <div className="bg-white grow p-6 lg:rounded-lg lg:p-10 lg:shadow-sm lg:ring-1 lg:ring-zinc-950/5 w-full">
                    {children}
                </div>
            </main>
        </div>
